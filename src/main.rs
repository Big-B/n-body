...
fn main() {
    ...
    let mercury: system::Particle = system::Particle::new(-1.1708e10, -5.7384e10, 0.0,
                                                          4.6276e4, -9.9541e3, 0.0, 3.3020e23);
    let venus: system::Particle = system::Particle::new(6.9283e10, 8.2658e10, 0.0,
                                                        -2.6894e4, 2.2585e4, 0.0, 4.8690e24);
    let earth: system::Particle = system::Particle::new(1.4960e11, 0.0, 0.0,
                                                            0.0, 2.98e04, 0.0, 5.972e24);
    let mars: system::Particle = system::Particle::new(-1.1055e11, -1.9868e11, 0.0,
